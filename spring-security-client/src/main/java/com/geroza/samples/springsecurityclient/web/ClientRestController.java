package com.geroza.samples.springsecurityclient.web;
...
public class ClientRestController {
    ...
    Mono<String> useOauthWithAuthCode(@RegisteredOAuth2AuthorizedClient("ger") OAuth2AuthorizedClient authorizedClient) {
