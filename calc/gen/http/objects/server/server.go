...
// MountShowHandler configures the mux to serve the "objects" service "show"
// endpoint.
...
// MountCreateHandler configures the mux to serve the "objects" service
// "create" endpoint.
...
// calls the "objects" service "create" endpoint.
