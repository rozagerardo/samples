...
import com.rozagerardosamples.web.dto.FooDto;
...
public class FooController {
    ...
    protected FooDto convertToDto(Foo entity) {
        FooDto dto = new FooDto(entity.getId(), entity.getName(), entity.getDateCreated());

        return dto;
    }

    protected Foo convertToEntity(FooDto dto) {
        Foo foo = new Foo(dto.name(), dto.dateCreated());
